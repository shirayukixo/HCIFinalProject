...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"Theme 1": [["overdrafting", "land clearing", "drought", "farming practices"],
			["natural resources", "erosion", "carbon", "waterlogging"],
			["deposition", "irrigation", "biological factors", "fertile"],
			["flooding", "aggregate", "overgrazing", "deforestation"],
			["surface runoff",  "crops",  "urbanization", "human impacts"]],

		"Theme 2": [["logging", "salt buildup", "overgrazing", "alkaline"],
			["greenery", "funnel", "farming", "aggregate"], 
			["roots", "deforestation", "organic matter", "structure"],
			["symbiotic", "alkaline", "drainage", "fungi overgrowth"],
			["soil erosion", "weather", "pesticides", "salt nutrients"]],

		"Theme 3": [["pesticides", "fertilizers", "overdrafting", "bacteria"],
			["erosion", "forest", "soil quality", "fertile"],
			["farming", "agriculture", "deep plowing", "vegetation"],
			["topsoil", "land degradation", "surface runoff", "alkaline"],
			["natural resources", "funnel", "symbiotic", "nutrients"]],

		"Theme 4": [["overgrazing", "soil erosion", "biodiversity", "agrochemicals"],
			["soil composition", "flooding", "clog waterways", "ecosystem"],
			["water", "land reclamation", "salinization", "conservation"],
			["tillage", "nature", "erosion", "urbanization"],
			["alkalinity", "rainforest", "overgrazing", "awareness"]]
